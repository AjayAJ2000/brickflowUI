...
app = db.App(
    theme={
        "branding": {"title": "Pipeline Observability 0.1.6"},
        "colors": {
            "primary": "#C81E5B",
    ...
    return db.Column(
        [
            db.Hero(
                ...
                subtitle="A 0.1.6 showcase with pipeline graphs, drilldowns, chart variety, kanban triage, and chatbot-style controls.",
                eyebrow="BrickflowUI 0.1.6",

...
Use `FunnelChart` when you want a purposeful, reusable building block instead of hand-assembling HTML-like structure in every page.
...
example = db.Card([
    db.Text("FunnelChart example", variant="h3"),

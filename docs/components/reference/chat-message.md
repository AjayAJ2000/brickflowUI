...
Use `ChatMessage` when you want a purposeful, reusable building block instead of hand-assembling HTML-like structure in every page.
...
example = db.Card([
    db.Text("ChatMessage example", variant="h3"),

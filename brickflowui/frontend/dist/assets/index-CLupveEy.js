const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/plotly.min-fW1B1z8j.js","assets/vendor-D_MD1exS.js"])))=>i.map(i=>d[i]);
import { r as reactExports, j as jsxRuntimeExports, R as React, a as ReactDOM } from "./vendor-D_MD1exS.js";
import { R as ResponsiveContainer, T as Treemap, F as FunnelChart, a as Tooltip, b as Funnel, C as Cell, c as RadarChart, P as PolarGrid, d as PolarAngleAxis, e as PolarRadiusAxis, L as Legend, f as Radar$1, g as ComposedChart, h as CartesianGrid, X as XAxis, Y as YAxis, A as Area, B as Bar, i as Line, S as ScatterChart, j as Scatter, k as PieChart, l as Pie, m as BarChart, n as LineChart, o as AreaChart } from "./charts-CbObG0ND.js";
(function polyfill() {
...
function quoteField(value, neutralizeFormula) {
...
function serializeCsv(columns, rows) {
  ...
  const body = rows.map((row) => columns.map((column) => quoteField(row[column.key], true)).join(","));
  return `\uFEFF${[header, ...body].join("\r\n")}`;
}
function StateMessage({ kind, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `bf-databricks-message bf-databricks-${kind}`, role: kind, children });
}
function WarehouseSelectorView({
  props,
  onSelect
}) {
  const warehouses = Array.isArray(props.warehouses) ? props.warehouses : [];
  const label = String(props.label || "SQL Warehouse");
  if (props.loading) return /* @__PURE__ */ jsxRuntimeExports.jsx(StateMessage, { kind: "status", children: "Loading warehouses..." });
  if (props.error) return /* @__PURE__ */ jsxRuntimeExports.jsx(StateMessage, { kind: "alert", children: String(props.error) });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "bf-form-field bf-databricks-selector", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bf-label", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: warehouses.length ? `Choose ${label.toLowerCase()}` : String(props.emptyMessage || "No warehouses available") }),
          warehouses.map((warehouse) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: String(warehouse.id), children: [
            String(warehouse.name || warehouse.id),
            warehouse.state ? ` - ${String(warehouse.state)}` : ""
          ] }, String(warehouse.id)))
        ]
      }
    )
...
function CatalogBrowserView({
  ...
  if (props.loading) return /* @__PURE__ */ jsxRuntimeExports.jsx(StateMessage, { kind: "status", children: "Loading catalogs..." });
  if (props.error) return /* @__PURE__ */ jsxRuntimeExports.jsx(StateMessage, { kind: "alert", children: String(props.error) });
  if (!catalogs.length) return /* @__PURE__ */ jsxRuntimeExports.jsx(StateMessage, { kind: "status", children: String(props.emptyMessage || "No catalogs available") });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-catalog-browser", "aria-label": "Unity Catalog browser", children: catalogs.map((catalog) => /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bf-catalog-group", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: String(catalog.name) }),
    (Array.isArray(catalog.schemas) ? catalog.schemas : []).map((schema) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bf-schema-group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-schema-name", children: String(schema.name) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-catalog-tables", children: (Array.isArray(schema.tables) ? schema.tables : []).map((table) => {
        const fullName = String(table.full_name || `${catalog.name}.${schema.name}.${table.name}`);
        const active = selected.catalog === catalog.name && selected.schema === schema.name && selected.table === table.name;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              table.table_type ? /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: String(table.table_type) }) : null
            ]
          },
          fullName
        );
...
function JobTriggerView({
  props,
  onTrigger
}) {
  const disabled = Boolean(props.disabled) || Boolean(props.loading);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bf-job-trigger", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          props.loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bf-spinner bf-spinner-sm" }) : null,
          String(props.label || "Run Job")
        ]
      }
    ),
    props.status ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `bf-badge bf-badge-${String(props.status).toLowerCase()}`, children: String(props.status) }) : null,
    props.runId ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bf-job-run-id", children: [
      "Run ",
      String(props.runId)
    ] }) : null,
    props.error ? /* @__PURE__ */ jsxRuntimeExports.jsx(StateMessage, { kind: "alert", children: String(props.error) }) : null
  ] });
}
...
function resolveIconName(name) {
  const cleaned = name.replace(/^lucide:/i, "").replace(/^icon:/i, "").trim();
  if (!cleaned) return "";
  if (LucideIcons[cleaned]) return cleaned;
  const pascal = cleaned.split(/[\s_-]+/).filter(Boolean).map((part) => part.charAt(0).toUpperCase() + part.slice(1)).join("");
...
function Icon({
  ...
  const LucideIcon = resolvedName ? LucideIcons[resolvedName] : void 0;
  const legacyPath = LUCIDE_ICON_MAP[resolvedName] || LUCIDE_ICON_MAP[name] || LUCIDE_ICON_MAP[name.trim()];
  ...
  if (legacyPath) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "svg",
      {
        ...
        strokeLinejoin: "round",
        "aria-hidden": "true",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: legacyPath })
      }
    );
  }
  if (!LucideIcon) return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className, style: { fontSize: size - 2, opacity: 0.6 }, children: "◆" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className, style: { fontSize: size - 2, opacity: 0.6 }, children: "*" });
}
...
function renderLoadingSkeleton(lines = 3) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-skeleton-stack", children: Array.from({ length: lines }).map((_, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-skeleton-line" }, index2)) });
}
function PlotComponent({ figure }) {
  const elementRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    if (!elementRef.current) return;
    const value = figure && typeof figure === "object" ? figure : {};
    const data = Array.isArray(value.data) ? value.data : [];
    const layout = value.layout && typeof value.layout === "object" ? value.layout : {};
    const config = value.config && typeof value.config === "object" ? value.config : { responsive: true };
    const element = elementRef.current;
    let active = true;
    let purge;
    void __vitePreload(async () => {
      const { default: Plotly } = await import("./plotly.min-fW1B1z8j.js").then((n) => n.p);
      return { default: Plotly };
    }, true ? __vite__mapDeps([0,1]) : void 0).then(({ default: Plotly }) => {
      if (!active) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: elementRef, className: "bf-chart-container" });
}
...
function renderNode(node, ctx, key) {
  ...
  switch (type) {
    ...
    case "Text": {
      ...
      const cls = ["bf-text-" + variant, p.muted ? "bf-text-muted" : "", p.bold ? "bf-text-bold" : "", p.italic ? "bf-text-italic" : "", p.className || ""].filter(Boolean).join(" ");
      const Tag2 = { h1: "h1", h2: "h2", h3: "h3", h4: "h4", code: "code", label: "label", caption: "small" }[variant] || "p";
      const style = { ...p.style || {} };
      if (p.color) style.color = p.color;
      return React.createElement(Tag2, { key, className: cls, style: Object.keys(style).length ? style : void 0 }, p.value);
    }
    case "Code":
    ...
    // ── Data display ───────────────────────────────────────────────────────
    case "Breadcrumbs":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "bf-breadcrumbs", "aria-label": "Breadcrumb", children: (p.items || []).map((item, index2, items) => {
    ...
    case "Badge":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `bf-badge bf-badge-${p.color || "blue"} ${p.className || ""}`.trim(), style: p.style, children: p.label }, key);
    case "Alert":
    ...
    // ── Charts ─────────────────────────────────────────────────────────────
    case "Plot":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(PlotComponent, { figure: p.figure }, key);
    case "AreaChart": {
      const yKeys = p.yKeys || [];
      const data = p.data || [];
    ...
    case "RadarChart": {
      ...
      return chartShell(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: p.height || 320, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(RadarChart, { data: p.data || [], children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Legend, {}),
          (p.valueKeys || []).map((yk, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Radar$1, { name: yk, dataKey: yk, stroke: colors[i % colors.length], fill: colors[i % colors.length], fillOpacity: 0.18 }, yk))
        ] }) })
      );
    }
    case "Heatmap":
    ...
    case "Timeline":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: resolveMotionClass(p, ["bf-timeline"]), style: resolveMotionStyle(p), children: [
        ...
        (p.items || []).map((item, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bf-timeline-item", children: [
    ...
    case "CatalogBrowser":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(CatalogBrowserView, { props: { ...p, loading: Boolean(p.loading) || isPending(p, ctx, ["select"]) }, onSelect: (value) => ev("select", value) }, key);
    case "WarehouseSelector":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(WarehouseSelectorView, { props: { ...p, loading: Boolean(p.loading) || isPending(p, ctx, ["select"]) }, onSelect: (value) => ev("select", value) }, key);
    case "JobTrigger": {
      const eventName = p.trigger ? "trigger" : "complete";
      return /* @__PURE__ */ jsxRuntimeExports.jsx(JobTriggerView, { props: { ...p, loading: Boolean(p.loading) || isPending(p, ctx, [eventName]) }, onTrigger: (value) => ev(eventName, value) }, key);
    }
    default:
...
function SidebarComponent({ props: p, children, ctx }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: `bf-sidebar ${mobileOpen ? "open" : ""}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "bf-nav-section", children: children.map((child, index2) => {
...
function TopNavComponent({ props: p, children, ctx }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: `bf-topnav ${p.sticky !== false ? "sticky" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bf-topnav-inner", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "bf-topnav-links", children: children.map((child, index2) => {
        const cp = child.props;
        const isActive = activePath === cp.path;
...
function AccordionComponent({ props: p, children, ctx, nodeKey }) {
  ...
  const toggle = (index2) => {
    setOpenItems((prev) => {
      if (prev.includes(index2)) return prev.filter((item) => item !== index2);
      if (allowMultiple) return [...prev, index2];
      return [index2];
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-accordion", children: children.map((child, index2) => {
    const cp = child.props;
    const open = openItems.includes(index2);
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `bf-accordion-item ${open ? "open" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "bf-accordion-trigger", onClick: () => toggle(index2), children: [
      ...
      open ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-accordion-content", children: renderChildren(child.children, ctx, `${nodeKey}-accordion-${index2}`) }) : null
    ] }, `${nodeKey}-${index2}`);
  }) });
}
...
function PipelineGraphComponent({ props: p, dispatch }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `bf-pipeline ${vertical ? "vertical" : "horizontal"} ${p.animated ? "animated" : ""}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-pipeline-canvas", children: nodes.map((node, index2) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(React.Fragment, { children: [
        ...
        index2 < nodes.length - 1 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `bf-pipeline-edge ${p.animated ? "pulse" : ""}` }) : null
      ] }, String(node.id ?? index2));
    }) })
  ] });
}
function StatusStripComponent({ props: p }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: resolveMotionClass(p, ["bf-status-strip"]), style: resolveMotionStyle(p), children: [
    p.title ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-card-title", children: p.title }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-status-strip-grid", style: { "--bf-status-cols": Number(p.columns || 4) }, children: items.map((item, index2) => {
...
function StepperComponent({ props: p }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: resolveMotionClass(p, [`bf-stepper`, `bf-stepper-${p.orientation || "horizontal"}`]), style: resolveMotionStyle(p), children: steps.map((step, index2) => {
    const state = index2 < active ? "complete" : index2 === active ? "active" : "pending";
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `bf-stepper-step ${state}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-stepper-dot", children: index2 + 1 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function validatePath(path) {
  if (!Array.isArray(path) || path.some((index2) => !Number.isInteger(index2) || index2 < 0)) {
    throw new PatchApplicationError("Patch path must contain non-negative integer indexes");
  }
}
function updateProps(tree, props) {
...
function applyPatch(tree, patch) {
  ...
  if (rest.length === 0) {
    ...
    if (op === "replace") {
      ...
      children[index2] = node;
      return { ...tree, children };
    }
    if (op === "update_props") {
      if (!props) throw new PatchApplicationError("Update-props patch requires props");
      children[index2] = updateProps(children[index2], props);
      return { ...tree, children };
    }
  }
  if (index2 >= children.length) {
    throw new PatchApplicationError(`Patch parent index ${index2} does not exist`);
  }
  children[index2] = applyPatch(children[index2], { ...patch, path: rest });
  return { ...tree, children };
}
...
const LOADING_BOOTSTRAP = readLoadingBootstrap();
...
function BuiltinLoadingMark() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bf-loading-mark", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bf-loading-mark-tile", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bf-loading-mark-bar bf-loading-mark-bar-long" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bf-loading-mark-bar bf-loading-mark-bar-medium" }),
...
function App() {
  ...
  const navigateTo = reactExports.useCallback((path, source) => {
    if (wsRef.current?.readyState === WebSocket.OPEN) {
  ...
  const navigate = reactExports.useCallback((path) => navigateTo(path, "user"), [navigateTo]);
  reactExports.useEffect(() => {
          ...
          if (msg.type === "full") {
            ...
            if (vdomRef.current) {
              try {
                ...
                const message = patchError instanceof PatchApplicationError ? patchError.message : "Unknown patch application failure";
